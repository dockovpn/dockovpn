...
| HOST_ADDR_OVERRIDE | Host address override if the resolved address doesn't work |  |
...
NET_ADAPTER and HOST_ADDR_OVERRIDE unless you absolutely have to. Now host address is determined automatically when container starts.
